...
//-----------------------------
{
    try
    {
        ...
        if (argc == 4)
        {
            ...
            if (radius < 1 || radius % 2 == 0) {
                std::string error_message;
                error_message  = "ERROR_INVALID_RADIUS\n";
                error_message += "Radius should be an odd number greater than 0";
                throw error_message;
            }
        }
		...
		cv::medianBlur(image, blur_image, radius);
